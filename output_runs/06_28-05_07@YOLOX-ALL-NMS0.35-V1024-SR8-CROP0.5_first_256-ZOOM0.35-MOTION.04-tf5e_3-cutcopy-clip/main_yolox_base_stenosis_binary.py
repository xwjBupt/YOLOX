...
class Exp(MyExp):
    def __init__(self):
        ...
        self.cut_copy_dict = dict(iou_thresh=0.2, paste_number=10, thresh=64, p=0.25)
        ...
        self.fold = "FOLD0"
        self.exp_name = "YOLOX-ALL-NMS0.35-V1024-SR8-CROP0.5_first_256-ZOOM0.35-MOTION.04-tf5e_3-cutcopy-clip"
